package com.prisonManagementSystem.utills;
    ...
    public static User generateUserFromJsonStr(String userStr) {
        ...
        try {
            ...
            for (String authorityStr : authorityStrList) {
                ...
                } else if(authorityStr.equals(Authority.ROLE_SECTION_ADMIN.getAuthority())) {
                    authorities.add(Authority.ROLE_SECTION_ADMIN);
