...
public class PrisonerUpdateDTO {
    ...
    public PrisonerUpdateDTO() {
    }

    public PrisonerUpdateDTO(ObjectId id, String name, String uniqueName, String fatherName, int age, String address, String dateOfIn, String dateOfOut, String caseType, String caseYear, String sectionId) {
        this.id = id;
        this.name = name;
